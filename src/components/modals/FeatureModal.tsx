      ...
      <ModalContent overflow="hidden" rounded="lg">
        ...
        <VStack align="start" gap={3} p={6}>
          ...
          <Text color="brand.slate.500">
            A curated list of the best talent on CoDesign that you can invite to
            participate in your listings to get high quality submissions! Add a
            new listing, or check out any of your currently live listings to try
            Scout.
          </Text>
          <Link
