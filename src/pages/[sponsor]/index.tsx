...
const SponsorListingsPage = ({ slug, sponsor, title, description }: Props) => {
  ...
  return (
    <Default
      ...
      meta={
        <Head>
          <title>{`${title} Opportunities | CoDesign`}</title>
          <meta
            name="description"
            content={`
...
`}
          />
          <meta property="og:title" content={`${title} on CoDesign`} />
          <meta property="og:image" content={ogImage.toString()} />
          <meta name="twitter:title" content={`${title} on CoDesign`} />
          <meta name="twitter:image" content={ogImage.toString()} />
          <meta name="twitter:card" content="summary_large_image" />
          <meta property="og:image:width" content="1200" />
          <meta property="og:image:height" content="630" />
          <meta property="og:image:alt" content={`${title} on CoDesign`} />
